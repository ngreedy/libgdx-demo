...
import vip.skyhand.libgdxtextureview.newspine.spine.AnimationState;
import vip.skyhand.libgdxtextureview.newspine.spine.AnimationStateData;
import vip.skyhand.libgdxtextureview.newspine.spine.Skeleton;
import vip.skyhand.libgdxtextureview.newspine.spine.SkeletonData;
import vip.skyhand.libgdxtextureview.newspine.spine.SkeletonJson;
import vip.skyhand.libgdxtextureview.newspine.spine.SkeletonRenderer;
import vip.skyhand.libgdxtextureview.newspine.spine.SkeletonRendererDebug;

public class NewVersionGdxAdapter extends ApplicationAdapter {
    ...
    public void create() {
        ...
        atlas = new TextureAtlas(Gdx.files.internal("old/cat_aldut.atlas"));
...
//        json.tempRegion = json1.tempRegion;
        SkeletonData skeletonData = json.readSkeletonData(Gdx.files.internal("old/cat_aldut.json"));
...
//        state.addAnimation(0, "zuoxia", false, 0); // Run after the jump.
        ...
        state.addListener(new AnimationState.AnimationStateAdapter() {
            ...
            public void start(AnimationState.TrackEntry entry) {
                super.start(entry);
                Log.e(TAG, "start: " + NewVersionGdxAdapter.this.hashCode());
            }
            ...
            public void complete(AnimationState.TrackEntry entry) {
                ...
                Log.e(TAG, "complete: " + NewVersionGdxAdapter.this.hashCode());
            }
        });
    }
