...
public class RippleView extends View implements ValueAnimator.AnimatorUpdateListener, Animator.AnimatorListener {
     ...
     * 默认半径 dp
     */
    private static final int NORMAL_RADIUS = 25;
    ...
    private void init() {
        ...
        mOutStrokePaint.setColor(Color.RED);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (mChangeRadius >= mRadius * 2.2) {
            canvas.drawCircle(mCx, mCy, (float) (mChangeRadius - (1.2 * mRadius)), mOutStrokePaint);
        }
//        if (mChangeRadius >= mRadius * 1.25) {
//            canvas.drawCircle(mCx, mCy, mChangeRadius - (2 * mRadius), mOutStrokePaint);
//        }
//
//        if (mChangeRadius >= mRadius * 1.3) {
...
//        }
    ...
    public void startRipple() {
        if (mValueAnimator == null) {
            ...
            mValueAnimator.setIntValues(2 * mRadius, (int) (2.5 * mRadius));
