 ...
 * @author mzechner
 */
public class AndroidGraphics implements Graphics, Renderer, GLTextureView.Renderer {
...
//        AndroidGL20.init();
    ...
    protected View createGLSurfaceView(AndroidApplicationBase application, final ResolutionStrategy resolutionStrategy) {
        ...
        if (config.useTextureView) {
            ...
            EGLConfigChooser configChooser = this.getEglConfigChooser();
    ...
    public void onPauseGLSurfaceView() {
        if (view != null) {
            ...
            else if (view instanceof GLSurfaceViewAPI18) ((GLSurfaceViewAPI18) view).onPause();
            else if (view instanceof GLSurfaceView) ((GLSurfaceView) view).onPause();
        }
    }
    ...
    public void onResumeGLSurfaceView() {
        if (view != null) {
            ...
            else if (view instanceof GLSurfaceViewAPI18) ((GLSurfaceViewAPI18) view).onResume();
            else if (view instanceof GLSurfaceView) ((GLSurfaceView) view).onResume();
        }
    }
